...
INSERT INTO tasklattice.access_policies (project_id, id, payload, created_at, updated_at, deleted_at) VALUES ('proj1', '00000000-0000-4000-8000-00000000da12', '{"id": "00000000-0000-4000-8000-00000000da12", "name": "Default", "status": "ACTIVE", "revision": 1, "createdAt": "2026-09-13T05:56:15.762578+00:00", "createdBy": "system:setup", "updatedAt": "2026-09-13T05:56:15.762578+00:00", "serverRules": []}', '2026-09-13 05:56:15.762578+00', '2026-09-13 05:56:15.762578+00', NULL);

INSERT INTO tasklattice.access_policy_versions (project_id, policy_id, revision, payload, created_at) VALUES ('proj1', '00000000-0000-4000-8000-00000000da12', 1, '{"actor": "system:setup", "summary": "Default deny-all Access Policy created during Project setup.", "policyId": "00000000-0000-4000-8000-00000000da12", "revision": 1, "snapshot": {"id": "00000000-0000-4000-8000-00000000da12", "name": "Default", "status": "ACTIVE", "revision": 1, "createdAt": "2026-09-13T05:56:15.762578+00:00", "createdBy": "system:setup", "updatedAt": "2026-09-13T05:56:15.762578+00:00", "serverRules": []}, "createdAt": "2026-09-13T05:56:15.762578+00:00"}', '2026-09-13 05:56:15.762578+00');

INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'general-purpose', '{"id": "general-purpose", "icon": "sparkles", "name": "General Purpose", "roleLabel": "General Assistant", "description": "A flexible Agent that starts without preselected capabilities.", "systemPrompt": "You are a focused internal assistant. Complete the user''s request inside the OpenShell sandbox and explain the evidence clearly.", "defaultSkillIds": [], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 0, '2026-09-13 05:56:14.1036+00', '2026-09-13 05:56:15.823976+00', NULL);
INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'hr', '{"id": "hr", "icon": "users", "name": "HR", "roleLabel": "HR Specialist", "description": "Provides support for HR policies, employee onboarding, benefits, and internal HR processes.", "systemPrompt": "You are an HR support Agent. Answer employee questions using approved company policies and connected knowledge sources. Be clear about policy scope, protect confidential employee data, and escalate decisions that require a People Operations owner.", "defaultSkillIds": ["employee-policy-search", "document-summarization", "onboarding-guidance"], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 1, '2026-09-13 05:56:14.10565+00', '2026-09-13 05:56:15.823976+00', NULL);
INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'research-analyst', '{"id": "research-analyst", "icon": "telescope", "name": "Research Analyst", "roleLabel": "Research Analyst", "description": "Collects evidence, compares sources, and produces citation-backed research.", "systemPrompt": "You are a research analyst. Investigate the request using approved sources, distinguish evidence from inference, cite material claims, surface uncertainty, and provide a concise decision-ready synthesis.", "defaultSkillIds": ["skill-web-research", "citation-builder", "document-summarization"], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 2, '2026-09-13 05:56:14.107293+00', '2026-09-13 05:56:15.823976+00', NULL);
INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'devops-engineer', '{"id": "devops-engineer", "icon": "settings", "name": "DevOps Engineer", "roleLabel": "DevOps Engineer", "description": "Investigates operational issues and reviews infrastructure changes safely.", "systemPrompt": "You are a DevOps engineering Agent. Diagnose from observable evidence, preserve production safety, explain operational risk, and propose reversible changes with explicit verification and rollback steps.", "defaultSkillIds": ["incident-triage", "infrastructure-change-review", "helm-chart-developer", "kubernetes-expert", "ocp-expert"], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 3, '2026-09-13 05:56:14.109269+00', '2026-09-13 05:56:15.823976+00', NULL);
INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'customer-support', '{"id": "customer-support", "icon": "headphones", "name": "Customer Support", "roleLabel": "Customer Support Specialist", "description": "Resolves product questions using approved support knowledge and escalation paths.", "systemPrompt": "You are a customer support Agent. Understand the customer''s goal, use approved support knowledge, give precise next actions, avoid unsupported claims, and escalate account or product issues that require a human owner.", "defaultSkillIds": ["customer-conversation-summary", "knowledge-answering"], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 4, '2026-09-13 05:56:14.111492+00', '2026-09-13 05:56:15.823976+00', NULL);
INSERT INTO tasklattice.agent_specializations (project_id, id, payload, sort_order, created_at, updated_at, deleted_at) VALUES ('proj1', 'custom', '{"id": "custom", "icon": "briefcase", "name": "Custom", "roleLabel": "Custom Agent", "description": "Define custom instructions and assemble capabilities from the available catalog.", "systemPrompt": "", "defaultSkillIds": [], "defaultMcpServerIds": [], "defaultKnowledgeSourceIds": []}', 5, '2026-09-13 05:56:14.113828+00', '2026-09-13 05:56:15.823976+00', NULL);

INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-002', '2026-09-13 05:24:15.055721+00', 'user', 'maya-chen', 'Maya Chen', 'maya.chen@example.com', 'admin', 'allowed', 'access_policy.update', 'updated', 'Access Policy', 'production-guardrails', 'Production Guardrails', 'success', 'Updated Access Policy “Production Guardrails” from revision 6 to 7.', 'req_01JZ8F8P2BKRY8EFQCSJD18YDG', 'PUT', '/api/v1/projects/individual/access-policies/production-guardrails', '10.28.4.16', 'Chrome 138 · Windows', '{"policyId": "production-guardrails"}', '{"effect": "allow", "revision": 7, "conditions": {"environment": "production"}, "principals": ["virtual-employee:security-reviewer"]}', '{"changeTicket": "SEC-2841", "previousRevision": 6}', NULL, NULL, 'individual:audit-002', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-003', '2026-09-13 04:38:15.055721+00', 'user', 'local-admin', 'Local Administrator', 'admin@tasklattice.local', 'admin', 'allowed', 'project_member.invite', 'invited', 'Project Member', 'alex.kim@example.com', 'alex.kim@example.com', 'success', 'Invited alex.kim@example.com to this Project as a user.', 'req_01JZ8CQKMZE6R7NV8NGHZ0MGH4', 'POST', '/api/v1/projects/individual/members/invitations', '192.168.10.24', 'Chrome 138 · macOS', '{}', '{"role": "user", "email": "alex.kim@example.com"}', '{"notification": "queued"}', NULL, NULL, 'individual:audit-003', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-006', '2026-09-12 03:56:15.055721+00', 'user', 'local-admin', 'Local Administrator', 'admin@tasklattice.local', 'admin', 'allowed', 'project_quota.update', 'updated', 'Project Quota', 'individual', 'Project quota', 'success', 'Updated Project monthly budget and token limits.', 'req_01JZ5KQQYYM4PDS1QDTQG412HC', 'PUT', '/api/v1/projects/individual/quota', '192.168.10.24', 'Chrome 138 · macOS', '{}', '{"tpmLimit": 1200000, "hardBudgetUsd": 2500, "budgetDuration": "30d"}', '{"revision": 4, "previousHardBudgetUsd": 2000}', NULL, NULL, 'individual:audit-006', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-007', '2026-09-11 01:56:15.055721+00', 'system', 'policy-reconciler', 'Policy Reconciler', NULL, 'system', 'allowed', 'access_policy.reconcile', 'reconciled', 'Access Policy', 'production-guardrails', 'Production Guardrails', 'success', 'Reconciled Access Policy “Production Guardrails” with the enforcement gateway.', 'req_01JZ33CF90S0KVKRDHKQBWQ3V7', 'POST', '/internal/reconciliation/access-policies/production-guardrails', '10.42.1.8', 'TaskLattice Policy Reconciler/0.2', '{"revision": 6}', NULL, '{"gateway": "managed", "durationMs": 418}', NULL, NULL, 'individual:audit-007', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-008', '2026-09-07 02:56:15.055721+00', 'user', 'alex-kim', 'Alex Kim', 'alex.kim@example.com', 'user', 'allowed', 'knowledge_source.read', 'viewed', 'Knowledge Source', 'security-runbooks', 'Security Runbooks', 'success', 'Viewed Knowledge Source “Security Runbooks”.', 'req_01JYN10K26PGDVSK7SDS1CV9T0', 'GET', '/api/v1/projects/individual/catalog', '172.16.8.44', 'Safari 18 · macOS', '{"id": "security-runbooks", "kind": "knowledge-source"}', NULL, '{"responseStatus": 200}', NULL, NULL, 'individual:audit-008', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-001', '2026-09-13 05:52:15.055721+00', 'user', 'local-admin', 'Local Administrator', 'admin@tasklattice.local', 'admin', 'allowed', 'instance.create', 'created', 'Instance', 'research-assistant', 'Research Assistant', 'success', 'Created Instance “Research Assistant” with the OpenClaw runtime.', 'req_01JZ8GFA1W8Q6BRF5TF5V6M5TQ', 'POST', '/api/v1/projects/individual/instances', '192.168.10.24', 'Chrome 138 · macOS', '{"source": "console"}', '{"name": "Research Assistant", "runtime": "openclaw", "instructions": "[REDACTED]", "modelProfileId": "balanced-global"}', '{"region": "cn-shanghai", "schemaVersion": 1}', '6e7f1c9a4c824b1aa7a5e68a0b134101', '8a6cb93f82c6461a', 'individual:audit-001', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-004', '2026-09-13 02:50:15.055721+00', 'service_account', 'deployment-bot', 'Deployment Bot', NULL, 'automation', 'allowed', 'runtime_policy.update', 'updated', 'Runtime Policy', 'restricted-egress', 'Restricted Egress', 'failed', 'Runtime Policy update failed validation because two network rules overlapped.', 'req_01JZ86X0EZ0X7BQ42RYCGQY79C', 'PUT', '/api/v1/projects/individual/runtime-policies/restricted-egress', '10.42.0.17', 'TaskLattice Deploy Bot/1.8', '{"dryRun": false}', '{"networkRules": [{"host": "*.internal.example", "port": 443}, {"host": "api.internal.example", "port": 443}]}', '{"pipeline": "policy-sync", "validationCode": "OVERLAPPING_NETWORK_RULES"}', '903fca7d2c204964bd1af2107062fdb4', 'e35b0b754d4f1f7c', 'individual:audit-004', NULL, NULL);
INSERT INTO tasklattice.audit_logs (project_id, id, occurred_at, actor_type, actor_id, actor_name, actor_email, authorization_role, authorization_decision, action, verb, object_type, object_id, object_name, outcome, summary, request_id, http_method, route, ip_address, user_agent, parameters, request_body, metadata, trace_id, span_id, record_id, authorization_capability, authorization_reason) VALUES ('proj1', 'audit-005', '2026-09-13 00:14:15.055721+00', 'user', 'maya-chen', 'Maya Chen', 'maya.chen@example.com', 'admin', 'denied', 'mcp_server.delete', 'deleted', 'MCP Server', 'production-github', 'Production GitHub', 'denied', 'Deletion of MCP Server “Production GitHub” was denied by a retention policy.', 'req_01JZ7Y7W7BF3CJJK43F6Q4CEEW', 'DELETE', '/api/v1/projects/individual/catalog/mcp-servers/production-github', '10.28.4.16', 'Chrome 138 · Windows', '{"force": false}', NULL, '{"policy": "retain-active-integrations", "activeBindings": 3}', 'b2884545403a40b3a9c5d6be1c68068f', '9ab3cb2a72c7a1fd', 'individual:audit-005', NULL, NULL);

    ...
    <main className="mx-auto max-w-5xl space-y-6 p-4 sm:p-6">
      ...
      <section className="overflow-hidden rounded-lg border bg-card">
        <header className="flex flex-wrap items-center justify-between gap-3 border-b p-4">
          ...
          <div className="flex gap-2"><Button variant="outline" onClick={() => open("new")}>New folder</Button><Button onClick={() => open("upload")}>Upload files</Button></div>
        </header>
        <div className="flex items-center gap-3 p-4">
          ...
          <ResourceActionsMenu resourceName="Operations evidence" actions={[
            { label: "Rename", icon: <Pencil />, onSelect: () => open("rename") },
            { label: "Move", icon: <Move />, onSelect: () => open("move") },

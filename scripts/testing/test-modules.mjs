...
export const testModules = [
  ...
  },
  {
    ...
    sourcePatterns: [
      ...
      "apps/control/server/runtime-inventory/**",
  ...
  {
    id: "expert-agent-delivery",
    block: "control-plane",
    label: "Control / Expert Agent development and delivery",
    sourcePatterns: [
      "apps/control/server/expert-agents/**",
      "apps/control/server/runtime-bridge/expert-agent-*",
      "apps/control/src/features/expert-agents/**",
      "apps/expert-agent-runtime/**",
    ],
    controlTestPatterns: [
      "apps/control/server/expert-agents/**",
      "apps/control/src/features/expert-agents/**",
    ...
    runnerTestPatterns: [],
    workspaceTests: [{
      workspace: "@tali/expert-agent-runtime",
      root: "apps/expert-agent-runtime",
      patterns: ["apps/expert-agent-runtime/src/**"],
    }],
  },
  {
    id: "memory",
  ...
  },
  {
    ...
    controlTestPatterns: [
      ...
      "apps/control/src/components/ui/**",
      "apps/control/src/i18n/**",
      "apps/control/src/features/project-overview/**",
      "apps/control/src/lib/canonical-origin.test.ts",
  ...
  },
  {
    ...
    workspaceTests: [{
      workspace: "@tali/example-mcp-server",
      root: "apps/example-mcp-server",
      patterns: ["apps/example-mcp-server/src/basic-auth.test.ts", "apps/example-mcp-server/src/github.test.ts"],
    }],
  },
  {
